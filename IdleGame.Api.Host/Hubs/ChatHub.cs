...
{
    public class ChatHub(IPlayerService playerService, IPvPService pvpService, IMappingRetrievalService mappingService) : Hub
    {
        ...
        private readonly IPvPService _pvPService = pvpService;
